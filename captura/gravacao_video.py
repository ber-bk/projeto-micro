...
class GravadorVideo:
    ...
    def __init__(self):
        ...
        self.diretorio_videos = "gravacoes/videos_missoes"
        ...
        try:
            ...
            while not self.parar_flag:
                ...
                while not self.parar_flag:
                    ...
                    # Pequeno delay para não sobrecarregar o CPU - Realmente necessario ? ( Verificar) - Sim, necessario, pensando em escala.
                    time.sleep(1.0 / fps)
